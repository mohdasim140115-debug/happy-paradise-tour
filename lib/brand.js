...
export const mailtoHref = (message, subject = "Kashmir Package Enquiry") =>
  `mailto:${BRAND.email}?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(message)}`;
...
export const DEFAULT_EMAIL_MESSAGE =
  "Hi Happy Paradise Tour & Travels,\n\nI am interested in the Kashmir Couple Package – 04 Nights / 05 Days at ₹22,000 per couple. Please share more details.\n\nThanks.";
